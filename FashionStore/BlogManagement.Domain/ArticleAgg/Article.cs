   ...
   public class Article : EntityBase
    {
        ...
        public string CanonialAddress { get; private set; }
        ...
        public Article(string title, string shortDescription, string description,
            ...
            string metaDescription, string keyword, string canonialAddress, long categoryId)
        {
            Title = title;
            ...
            Keyword = keyword;
            CanonialAddress = canonialAddress;
